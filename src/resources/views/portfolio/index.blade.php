...
<title>Isad — Mahasiswa &amp; Frontend Dev</title>
...
<header class="fixed inset-x-0 top-0 z-50 transition-all duration-300"
  ...
  <nav class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between" aria-label="Main navigation">
    ...
    <a href="#hero" class="font-display font-bold text-xl tracking-tight relative z-10">
      <span class="text-zinc-900 dark:text-white">Is</span><span class="text-accent">ad</span>
    </a>

    <ul class="hidden md:flex items-center gap-8 text-sm" role="list">
      <li><a href="#services" class="nl text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors" :class="s==='services'?'on !text-zinc-900 dark:!text-white':''">Services</a></li>
...
<section id="hero" class="relative min-h-screen flex items-center pt-16 overflow-hidden">
  ...
  <div class="relative z-10 max-w-6xl mx-auto px-6 py-24 w-full">
    <div class="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
       <p class="reveal text-sm font-medium text-accent tracking-widest uppercase mb-4">
            {{ $profile?->label ?? 'Mahasiswa Sistem Informasi' }}
        </p>
        ...
        <h1 class="reveal d1 font-display font-bold text-5xl md:text-6xl lg:text-7xl leading-[1.05] tracking-tight text-zinc-900 dark:text-white mb-6">
            Hi, I'm <span class="text-accent">{{ $profile?->name ?? 'Isad' }}</span>
        </h1>

        <p class="reveal d2 text-lg md:text-xl text-zinc-500 dark:text-zinc-400 font-light leading-relaxed max-w-md mb-10">
            {{ $profile?->description ?? 'Saya seorang mahasiswa Sistem Informasi yang tertarik pada web development, backend system, dan pengembangan aplikasi berbasis Laravel.' }}
        </p>
  ...
  <div>
    <p class="font-display font-bold text-3xl text-zinc-900 dark:text-white">
      {{ $profile?->stat_project ?? '3+' }}
    </p>
  ...
  <div>
    <p class="font-display font-bold text-3xl text-zinc-900 dark:text-white">
      {{ $profile?->stat_major ?? 'SI' }}
    </p>
    <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Major</p>
  </div>

  <div>
    <p class="font-display font-bold text-3xl text-zinc-900 dark:text-white">
      {{ $profile?->stat_university ?? 'Esa Unggul' }}
    </p>
    <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">University</p>
  </div>
</div>
        </div>
      </div>

      <div class="reveal d2 flex justify-center md:justify-end md:-mt-[500px]">
        <div class="relative w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96">
          <div class="pf w-full h-full rounded-3xl">
            <img 
                src="{{ str_contains($profile?->photo, 'profiles/')
                    ? asset('storage/' . $profile->photo)
                    : asset($profile?->photo ?? 'assets/img/profile.jpeg') }}"
                    
                alt="{{ $profile?->name ?? 'Isad' }}"
                loading="eager"
              >
          </div>
...
<section id="services" class="py-24 bg-zinc-50 dark:bg-zinc-900/40">
  <div class="max-w-6xl mx-auto px-6">
    <div class="mb-14">
      <p class="reveal text-xs font-medium text-accent tracking-widest uppercase mb-3">MY SKILLS</p>
      <h2 class="reveal d1 font-display font-bold text-4xl md:text-5xl text-zinc-900 dark:text-white">WHAT I DO</h2>
    </div>
    <div class="grid md:grid-cols-3 gap-6">
      ...
      <article class="reveal d1 card-h group bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-100 dark:border-zinc-800 hover:border-accent">
        ...
        <h3 class="font-display font-bold text-xl text-zinc-900 dark:text-white mb-3">Laravel Development</h3>
        <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">Membangun aplikasi web menggunakan Laravel, Blade, Livewire, dan Filament dengan fokus pada backend system dan integrasi database.</p>
      </article>
      ...
      <article class="reveal d2 card-h group bg-zinc-900 dark:bg-zinc-800 rounded-2xl p-8 border border-zinc-800 hover:border-accent">
        ...
        <h3 class="font-display font-bold text-xl text-white mb-3">Java App Development</h3>
        <p class="text-sm text-zinc-400 leading-relaxed">Membangun aplikasi Java dengan fokus pada arsitektur yang baik dan kualitas kode yang tinggi.</p>
      </article>
      ...
      <article class="reveal d3 card-h group bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-100 dark:border-zinc-800 hover:border-accent">
        ...
        <h3 class="font-display font-bold text-xl text-zinc-900 dark:text-white mb-3">Research & Writing</h3>
        <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">Berpengalaman dalam melakukan penelitian dan menulis artikel teknis.</p>
      </article>
...
<section id="work" class="py-24">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="mb-14">
            <p class="text-accent uppercase text-sm tracking-widest mb-3">
                My Projects
            </p>
        ...
        <div class="grid gap-8">
            ...
            <div class="rounded-3xl border border-zinc-800 overflow-hidden bg-zinc-900">

                <img 
                  src="{{ str_starts_with($portfolio->image, 'portfolio/') 
                ...
                <div class="p-8">
                    ...
                    <div class="flex gap-2 mb-4">
                        ...
                        <span class="px-3 py-1 rounded-full bg-orange-500/10 text-orange-400 text-xs">
                            {{ $portfolio->category }}
                        </span>

                        <span class="px-3 py-1 rounded-full bg-zinc-800 text-zinc-300 text-xs">
...
<section class="py-24 bg-zinc-50 dark:bg-zinc-900/40">
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="mb-10">
      <p class="text-xs font-medium text-accent tracking-widest uppercase mb-3">PROJECT AKHIR</p>
      <h2 class="font-display font-bold text-4xl md:text-5xl text-zinc-900 dark:text-white mb-4">
        {{ $mainReport->title }}
      </h2>
      <p class="text-zinc-500 dark:text-zinc-400 max-w-3xl">
        {{ $mainReport->description }}
      </p>
    </div>

    <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 mb-8">
      <div class="flex justify-between text-sm mb-3">
        <span class="text-accent">{{ ucfirst(str_replace('_', ' ', $mainReport->status)) }}</span>
        <span class="text-zinc-400">{{ $mainReport->progress_percentage }}%</span>
      </div>

      <div class="w-full h-3 bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden">
        <div class="h-3 bg-accent rounded-full" style="width: {{ $mainReport->progress_percentage }}%"></div>
      </div>
    </div>

    <h3 class="font-display font-bold text-2xl text-zinc-900 dark:text-white mb-5">
      Progress Pengerjaan
    </h3>
      ...
      @foreach ($reportTasks as $task)
        <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
          <div class="flex items-center justify-between mb-2">
            <h4 class="font-bold text-zinc-900 dark:text-white">{{ $task->title }}</h4>
            <span class="text-sm text-zinc-400">{{ $task->progress_percentage }}%</span>
          </div>
          ...
          <div class="w-full h-2 bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden">
            <div class="h-2 bg-accent rounded-full" style="width: {{ $task->progress_percentage }}%"></div>
          </div>
        </div>
      @endforeach
    </div>
    ...
    <div class="mt-14">
      <p class="text-xs font-medium text-accent tracking-widest uppercase mb-3">
        System Design
      </p>

      <h3 class="font-display font-bold text-3xl text-zinc-900 dark:text-white mb-8">
        ERD & Flowchart
      </h3>

      <div class="grid md:grid-cols-2 gap-6">
        <article class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
          <h4 class="font-bold text-zinc-900 dark:text-white mb-4">
            Entity Relationship Diagram
          </h4>

          <img src="{{ asset('assets/img/erd.jpg') }}"
               alt="ERD Sistem Informasi Penyewaan Lapangan Padel"
        ...
        <article class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
          ...
          <img src="{{ asset('assets/img/flowchart.jpg') }}"
               alt="Flowchart Sistem Informasi Penyewaan Lapangan Padel"
               class="w-full rounded-xl border border-zinc-200 dark:border-zinc-800">
        </article>
      </div>
    </div>
    ...
    <div class="grid md:grid-cols-2 gap-16 items-center">
      ...
      <div class="reveal order-2 md:order-1">
        <div class="pf w-full aspect-square max-w-sm mx-auto rounded-3xl">
          <img src="{{ asset('assets/img/profile.jpeg') }}" alt="Eliott" loading="lazy">
        </div>
      </div>

      <div class="order-1 md:order-2">
        <p class="reveal text-xs font-medium text-accent tracking-widest uppercase mb-3">bio</p>
        <h2 class="reveal d1 font-display font-bold text-4xl md:text-5xl text-zinc-900 dark:text-white leading-tight mb-6">About<br>me</h2>
        <p class="reveal d2 text-zinc-500 dark:text-zinc-400 leading-relaxed mb-4">
          Saya Raihan Isad, seorang mahasiswa Universitas Esa Unggul dengan jurusan Sistem Informasi. Saya memiliki minat yang besar dalam bidang UI/UX Design dan Frontend Development, dan saya bersemangat untuk menciptakan pengalaman digital yang menarik dan fungsional.
        </p>
        <p class="reveal d3 text-zinc-500 dark:text-zinc-400 leading-relaxed mb-8">
          Beberapa project yang sudah saya lakukan mencakup Java app development, IGI Researcher, dan pengembangan aplikasi Laravel.
        </p>
        <div class="reveal d4">
          ...
          <div class="flex flex-wrap gap-2" role="list" aria-label="Skills">
            <span role="listitem" class="stag text-sm bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 px-3.5 py-1.5 rounded-full hover:border-accent">Laravel</span>
            <span role="listitem" class="stag text-sm bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 px-3.5 py-1.5 rounded-full hover:border-accent">Blade</span>
            <span role="listitem" class="stag text-sm bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 px-3.5 py-1.5 rounded-full hover:border-accent">Livewire</span>
            <span role="listitem" class="stag text-sm bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 px-3.5 py-1.5 rounded-full hover:border-accent">Livewire</span>
            <span role="listitem" class="stag text-sm bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 px-3.5 py-1.5 rounded-full hover:border-accent">Java</span>
            <span role="listitem" class="stag text-sm bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 px-3.5 py-1.5 rounded-full hover:border-accent">MariaDB</span>
            ...
            <span role="listitem" class="stag text-sm bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 px-3.5 py-1.5 rounded-full hover:border-accent">GitHub</span>
          </div>
        </div>
      </div>
  ...
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      ...
      <blockquote class="reveal d1 bg-zinc-50 dark:bg-zinc-900 rounded-2xl p-7 border border-zinc-100 dark:border-zinc-800">
        ...
        <p class="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed mb-6 italic">"Isad delivered our redesign in record time and the quality blew us away. Our conversion rate jumped 28% in the first month. Absolutely recommend."</p>
        <footer class="flex items-center gap-3">
          <div class="pf w-10 h-10 rounded-full shrink-0"><img src="https://i.pravatar.cc/80?img=11" alt="Sarah Müller" loading="lazy"></div>
          <div>
            <p class="font-medium text-sm text-zinc-900 dark:text-white">Sarah Müller</p>
            <p class="text-xs text-zinc-500">CPO, Novu</p>
          </div>
        </footer>
      </blockquote>
      ...
      <blockquote class="reveal d2 bg-zinc-900 dark:bg-zinc-800 rounded-2xl p-7 border border-zinc-800">
        ...
        <p class="text-zinc-400 text-sm leading-relaxed mb-6 italic">"Working with Isad is a dream. He asks the right questions, moves fast, and the final result always exceeds what we imagined. Our best hire of 2024."</p>
        <footer class="flex items-center gap-3">
          <div class="pf w-10 h-10 rounded-full shrink-0"><img src="https://i.pravatar.cc/80?img=52" alt="Thomas Renault" loading="lazy"></div>
          <div>
            <p class="font-medium text-sm text-white">Thomas Renault</p>
            <p class="text-xs text-zinc-500">Founder, Finlo</p>
          </div>
        </footer>
      </blockquote>
      ...
      <blockquote class="reveal d3 bg-zinc-50 dark:bg-zinc-900 rounded-2xl p-7 border border-zinc-100 dark:border-zinc-800">
        ...
        <p class="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed mb-6 italic">"We had a tight deadline and a vague brief. Isad turned both into a polished site in under two weeks. Clean code, zero hand-holding needed."</p>
        <footer class="flex items-center gap-3">
          <div class="pf w-10 h-10 rounded-full shrink-0"><img src="https://i.pravatar.cc/80?img=47" alt="Camille Dufresne" loading="lazy"></div>
          <div>
            <p class="font-medium text-sm text-zinc-900 dark:text-white">Camille Dufresne</p>
            <p class="text-xs text-zinc-500">Creative Director, Orea</p>
          </div>
        </footer>
      </blockquote>
...
<section id="blog" class="py-24 bg-zinc-50 dark:bg-zinc-900/40">
  <div class="max-w-6xl mx-auto px-6">
    <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-14">
      ...
      <a class="reveal d1 text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-accent transition-colors self-start sm:self-auto nl">Latest works →</a>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-6">
      ...
      <article class="reveal d1 card-h group bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 hover:border-accent">
        <div class="pf w-full h-44">
          <img src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=700&q=80" alt="Why I ditched CSS frameworks" loading="lazy">
        </div>
        <div class="p-6">
          <div class="flex items-center gap-3 mb-3">
            <span class="text-xs bg-orange-50 dark:bg-zinc-800 text-accent border border-orange-200 dark:border-zinc-700 px-2.5 py-1 rounded-full">Laravel</span>
            <span class="text-xs text-zinc-400">Mar 8, 2025</span>
          </div>
          <a href="{{ url('/blog-article') }}">
            <h3 class="font-display font-bold text-lg text-zinc-900 dark:text-white mb-2 group-hover:text-accent transition-colors">Building Public Service Report System with Laravel</h3>
          </a>
          <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed mb-4">Pengembangan sistem laporan layanan publik menggunakan Laravel, Filament, dan database MariaDB.</p>
          <a class="inline-flex items-center gap-1.5 text-sm font-medium text-zinc-900 dark:text-white nl">View details →</a>
        </div>
      </article>
      ...
      <article class="reveal d2 card-h group bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 hover:border-accent">
        <div class="pf w-full h-44">
          <img src="https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=700&q=80" alt="Design systems" loading="lazy">
        </div>
        <div class="p-6">
          <div class="flex items-center gap-3 mb-3">
            <span class="text-xs bg-orange-50 dark:bg-zinc-800 text-accent border border-orange-200 dark:border-zinc-700 px-2.5 py-1 rounded-full">Research</span>
            <span class="text-xs text-zinc-400">Feb 21, 2025</span>
          </div>
          <a href="{{ url('/blog-article') }}">
            <h3 class="font-display font-bold text-lg text-zinc-900 dark:text-white mb-2 group-hover:text-accent transition-colors">Business Model Innovation Through Immersive Technologies</h3>
          </a>
          <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed mb-4">Penelitian mengenai Industry 5.0, digital twins, dan metaverse dalam inovasi model bisnis modern.</p>
          <a class="inline-flex items-center gap-1.5 text-sm font-medium text-zinc-900 dark:text-white nl">View details →</a>
        </div>
      </article>

      <article class="reveal d3 card-h group bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 hover:border-accent">
        <div class="pf w-full h-44">
          <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=700&q=80" alt="Freelance lessons" loading="lazy">
        </div>
        <div class="p-6">
          <div class="flex items-center gap-3 mb-3">
            <span class="text-xs bg-orange-50 dark:bg-zinc-800 text-accent border border-orange-200 dark:border-zinc-700 px-2.5 py-1 rounded-full">Java</span>
            <span class="text-xs text-zinc-400">Jan 14, 2025</span>
          </div>
          <a href="{{ url('/blog-article') }}">
            <h3 class="font-display font-bold text-lg text-zinc-900 dark:text-white mb-2 group-hover:text-accent transition-colors">Learning Object-Oriented Programming with Java</h3>
          </a>
          <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed mb-4">Pengembangan aplikasi Java berbasis OOP untuk kebutuhan pembelajaran dan project kampus.</p>
          <a class="inline-flex items-center gap-1.5 text-sm font-medium text-zinc-900 dark:text-white nl">View details →</a>
        </div>
      </article>
    ...
    <div class="bg-zinc-900 dark:bg-zinc-800 rounded-3xl p-10 md:p-16 relative overflow-hidden">
      ...
      <div class="relative z-10 grid md:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <p class="reveal d2 text-zinc-400 leading-relaxed mb-8">I'm open to UI/UX and frontend missions, short or long-term. Landing page, full product redesign, or just a second pair of eyes — let's talk.</p>

          <div class="reveal d3 flex flex-col gap-4">
            <a href="mailto:raihanisad2007@gmail.com" class="group flex items-center gap-3 text-zinc-400 hover:text-white transition-colors">
              ...
              <span class="text-sm">raihanisad2007@gmail.com</span>
            </a>
            <a href="https://www.instagram.com/kil4.er/" rel="noopener noreferrer" target="_blank" class="group flex items-center gap-3 text-zinc-400 hover:text-white transition-colors">
              <span class="w-9 h-9 flex items-center justify-center bg-zinc-800 rounded-lg group-hover:bg-accent/20 transition-colors shrink-0">
                  <img src="{{ asset('assets/icons/instagram-logo.svg') }}" 
                    alt="Instagram"
                    class="w-4 h-4">
              </span>
              <span class="text-sm">https://www.instagram.com/kil4.er/</span>
            </a>
            <a href="https://github.com/kill4enemy" rel="noopener noreferrer" target="_blank" class="group flex items-center gap-3 text-zinc-400 hover:text-white transition-colors">
              <span class="w-9 h-9 flex items-center justify-center bg-zinc-800 rounded-lg group-hover:bg-accent/20 transition-colors shrink-0">
              ...
              <span class="text-sm">github.com/kill4enemy</span>
            </a>
          </div>
        </div>
...
<footer class="border-t border-zinc-100 dark:border-zinc-900">
  <div class="max-w-6xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
    <p class="text-sm text-zinc-400">© <span id="yr"></span> Isad. All rights reserved. <br> Developed by <a href="https://lbegey78.gumroad.com/" target="_blank" class="font-bold">Laurent Begey</a> • Distributed by <a href="https://themewagon.com/" target="_blank" class="font-bold">ThemeWagon</a></p>
    <p class="text-xs text-zinc-500">Built with
      ...
      &amp;
      <a href="https://laravel.com" rel="noopener noreferrer" target="_blank" class="hover:text-accent transition-colors">Laravel</a>
    </p>
  </div>
</footer>
